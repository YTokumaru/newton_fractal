...
// configuration step. It creates a namespace called `newton_fractal`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", newton_fractal::cmake::project_name, newton_fractal::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", newton_fractal::cmake::project_version);
      return EXIT_SUCCESS;
    }
